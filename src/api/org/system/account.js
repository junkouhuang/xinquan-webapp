...
export default {
  ...
  searchRequest: data => {
    ...
    return request({
      url: '/authorizes/simple/account/query',
      method: 'post',
      data: formData
    })
  },
  ...
  addRequest: data => {
    ...
    return request({
      url: '/authorizes/simple/account/create',
      method: 'post',
      data: formData
    })
  },
  ...
  updateRequest: data => {
    ...
    data.departmentId && formData.append('departmentId', data.departmentId)
    return request({
      url: '/authorizes/simple/account/save',
      method: 'post',
      data: formData
    })
  },
  ...
  // 获取账号选择角色列表
  getAccountRoles: (orgId) => {
    let formData = new FormData()
    formData.append('orgId', orgId)
    return request ({
      url: '/authorizes/simple/account/permission',
      method: 'post',
      data: formData
    })
  },
