    ...
    <el-card shadow="never" class="mt20">
      <el-form :model="form" :rules="rules" ref="ruleForm" label-width="120px" >
        ...
        <el-form-item label="是否强制更新" prop="forceUpdate">
          <el-radio v-model="form.forceUpdate" :label="true" >是</el-radio>
          <el-radio v-model="form.forceUpdate" :label="false" >否</el-radio>
        </el-form-item>
        <el-form-item label="是否自动更新" prop="autoUpdate">
          <el-radio v-model="form.autoUpdate" :label="true" >是</el-radio>
          <el-radio v-model="form.autoUpdate" :label="false" >否</el-radio>
        </el-form-item>
        <el-form-item label="是否启用" prop="run">
          <el-radio v-model="form.run" :label="true" >是</el-radio>
          <el-radio v-model="form.run" :label="false" >否</el-radio>
        </el-form-item>
        ...
        <el-form-item label="是否废弃" prop="discarded">
          <el-radio v-model="form.discarded" :label="true" >是</el-radio>
          <el-radio v-model="form.discarded" :label="false" >否</el-radio>
        </el-form-item>
        <el-form-item label="应用包" prop="apkUrl" v-if="form.type==1 || form.type==3 || androidVisible" style="max-width: 600px" >
          <el-input v-model="form.apkUrl" type="text" maxlength="200" placeholder="" clearable disabled></el-input>
        </el-form-item>
        <el-form-item label="IOS URL" prop="apkUrl" v-if="form.type==2 || iosVisible" style="max-width: 600px" >
          <el-input v-model="form.apkUrl" type="text" maxlength="200" placeholder="" clearable disabled></el-input>
        </el-form-item>
        <el-form-item label="应用包校验码" prop="apkCheckCode" style="max-width: 600px" >
          <el-input v-model="form.apkCheckCode" type="text" maxlength="200" placeholder="" clearable ></el-input>
        </el-form-item>
        <el-form-item label="增量包" prop="incrementalUrl" v-if="form.type==3 || h5Visible" style="max-width: 600px" >
          <el-input v-model="form.incrementalUrl" type="text" maxlength="200" placeholder="" clearable disabled></el-input>
        </el-form-item>
        <el-form-item label="增量包校验码" prop="incrementalCheckCode" v-if="form.type==3 || h5Visible" style="max-width: 600px">
          <el-input v-model="form.incrementalCheckCode" type="text" maxlength="200" placeholder="" clearable ></el-input>
        </el-form-item>
        <el-form-item label="APP版本包" prop="parentId" v-if="form.type==3 || h5Visible" style="max-width: 600px" >
          <el-select placeholder="选择APP版本包" v-model="form.parentId" style="max-width: 600px;" filterable >
        ...
        <el-form-item label="内容信息" prop="content" style="max-width: 600px">
          <el-input v-model="form.content" type="textarea" show-word-limit maxlength="200" placeholder="" clearable ></el-input>
        </el-form-item>
        <br/><br/>
        <el-form-item>
          <el-button type="blue" v-has="'res_version_app_save'" @click="submitForm">保存提交</el-button>
