  ...
  <div>
    ...
    <el-card shadow="never" class="mt20">
      <div slot="header" class="clearfix">
        <div class="pull-left">
          <el-button type="blue" v-has="'res_feedback_add'" @click="$router.push({path: '/minle/feedback/add'})">新增反馈</el-button>
        ...
        <el-table-column label="操作" width="135">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" v-has="'res_feedback_detail'" content="查看" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/minle/feedback/detail/${scope.row.id}` })"  type="text" >
                <i class="iconfont">&#xe605;</i>
              </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" v-has="'res_feedback_edit'" content="编辑" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/minle/feedback/${scope.row.id}` })" type="text" >
                <i class="iconfont">&#xe71c;</i>
              </el-button>
            </el-tooltip>
...
<script>
import request from "@/api/minle/feedback"
export default {
  data() {
    return {
      searchKeyword: '',
