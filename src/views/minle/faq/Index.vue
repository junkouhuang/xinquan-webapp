  ...
  <div>
    <el-card shadow="never" class="head-search-card mt20">
      <el-form :model="query" ref="searchForm" label-width="75px">
        <el-row :gutter="20">
          ...
          <el-col :xl="{span: 6}" :lg="{span: 8}" :sm="{span: 12}">
            <el-button type="blue" v-has="'res_minle_faq_list'" @click="loadCoursePackage">查 询</el-button>
    ...
    <el-card shadow="never" class="mt20">
      <div slot="header" class="clearfix">
        <div class="pull-left">
          <el-button type="blue" v-has="'res_minle_faq_add'" @click="$router.push({path: '/minle/faq/add'})">新增问题</el-button>
          <el-button type="danger" v-has="'res_minle_faq_batch_delete'" @click="handleDeleteSelected">删除问题</el-button>
          <el-button type="green" v-has="'res_minle_faq_exports'" @click="handleExports">导出数据</el-button>
        </div>
      ...
      <el-table
        ...
        <el-table-column label="操作" width="135">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" v-has="'res_minle_faq_detail'" content="查看" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/minle/faq/detail/${scope.row.id}` })"  type="text" >
                <i class="iconfont">&#xe605;</i>
              </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" v-has="'res_minle_faq_edit'" content="编辑" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/minle/faq/${scope.row.id}` })" type="text" >
                <i class="iconfont">&#xe71c;</i>
              </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" v-has="'res_minle_faq_detete'" content="删除" placement="top">
              <el-button class="reset-icon" @click="handleDelete(scope.row)" type="text" >
                <i class="iconfont">&#xe614;</i>
              </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" v-has="'res_minle_faq_enable'" content="启用" placement="top" v-if="scope.row.status==2">
