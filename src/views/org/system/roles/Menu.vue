<template>
  <div>
    <el-card shadow="never" class="mt20">
      ...
      <div class="mt20">
        <el-button type="blue" v-has="'res_org_roles_permission'" @click="handleSubmit">保存提交</el-button>
...
export default {
  ...
  created() {
    ...
    formData.append('orgId', this.$route.params.orgId)
    this.axios.post('/authorizes/simple/roles/permission', formData).then(res => {
      ...
      if (resourcesKeys.length > 0) {
        ...
        this.axios.post('/authorizes/simple/roles/permission', formData).then(res => {
          if (res.returnCode == 'ERR_0000') {
            ...
            this.$router.push({path: '/organization/roles'})
          } else {
