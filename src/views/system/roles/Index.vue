  ...
  <div>
    <el-card shadow="never" class="mt20">
      <el-form label-width="80px" :model="query" ref="searchForm">
        <el-row :gutter="20">
          ...
          <el-col :xl="{span: 6}" :lg="{span: 8}" :sm="{span: 12}">
            <el-button type="blue" v-has="'res_roles_list'" @click="getList">查 询</el-button>
    ...
    <el-card shadow="never" class="mt20">
      <div slot="header" class="clearfix">
        <div class="pull-left">
          <el-button type="blue" v-has="'res_roles_add'" @click="$router.push('/system/roles/add')">新增角色</el-button>
          <el-button type="danger" v-has="'res_roles_batch_delete'" @click="handleDeleteSelected">删除角色</el-button>
        </div>
      ...
      <el-table
        ...
        <el-table-column label="操作" width="100">
          <template slot-scope="scope">
            <el-tooltip class="item" v-has="'res_roles_permission'" effect="dark" content="分配权限" placement="top">
              <el-button class="reset-icon" @click="$router.push(`/system/roles/${scope.row.roleKey}/menu`)" type="text" icon="el-icon-setting"></el-button>
            </el-tooltip>
            <el-tooltip class="item" v-has="'res_roles_edit'" effect="dark" content="编辑" placement="top">
              <el-button class="reset-icon" @click="$router.push(`/system/roles/${scope.row.roleKey}`)" type="text" icon="el-icon-edit-outline"></el-button>
            </el-tooltip>
            <el-tooltip class="item" v-has="'res_roles_delete'" effect="dark" content="删除" placement="top">
...
<script>
import { getRolesList, deleteRole, deleteBatchRole, queryOrgRequest } from '@/api/system/roles'
export default {
  data() {
    return {
      searchKeyword: '',
