  ...
  <div>
    <el-card shadow="never" class="head-search-card mt20">
      <el-form :model="query" ref="searchForm" label-width="75px">
        <el-row :gutter="20">
          ...
          <el-col :xl="{span: 6}" :lg="{span: 8}" :sm="{span: 12}">
            <el-button type="blue" v-has="'res_mmc_feedback_list'" @click="loadCoursePackage">查 询</el-button>
    ...
    <el-card shadow="never" class="mt20">
      <div slot="header" class="clearfix">
        <div class="pull-left">
          <el-button type="blue" v-has="'res_mmc_feedback_add'" @click="$router.push({path: '/mmc/feedback/add'})">新增反馈</el-button>
          <el-button type="danger" v-has="'res_mmc_feedback_delete'" @click="handleDeleteSelected">删除反馈</el-button>
          <el-button type="green" v-has="'res_mmc_feedback_exports'" @click="handleExports">导出记录</el-button>
        </div>
        ...
        <el-table-column label="操作" width="135">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" v-has="'res_mmc_feedback_detail'" content="查看" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/mmc/feedback/detail/${scope.row.id}` })"  type="text" >
                <i class="iconfont">&#xe605;</i>
              </el-button>
            </el-tooltip>
            <el-tooltip class="item" effect="dark" v-has="'res_mmc_feedback_edit'" content="编辑" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/mmc/feedback/${scope.row.id}` })" type="text" >
                <i class="iconfont">&#xe71c;</i>
              </el-button>
            </el-tooltip>
