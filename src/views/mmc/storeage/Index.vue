  ...
  <div>
    <el-card shadow="never" class="head-search-card mt20">
      <el-form :model="query" ref="searchForm" label-width="75px">
        <el-row :gutter="20">
          ...
          <el-col :xl="{span: 6}" :lg="{span: 8}" :sm="{span: 12}">
            <el-button type="blue" v-has="'res_mmc_media_resource_list'" @click="loadCoursePackage">查 询</el-button>
    ...
    <el-card shadow="never" class="mt20">
      <div slot="header" class="clearfix">
        <div class="pull-left">
          <el-button type="blue" v-has="'res_mmc_media_resource_add'" @click="$router.push({path: '/mmc/storeage/add'})">新增资源</el-button>
          <el-button type="danger" v-has="'res_mmc_media_resource_batch_delete'" @click="handleDeleteSelected">批量删除</el-button>
        </div>
      ...
      <el-table
        ...
        <el-table-column label="操作" width="100">
          <template slot-scope="scope">
            <el-tooltip v-has="'res_mmc_media_resource_download'" class="item" effect="dark" content="下载" placement="top">
              <el-link type="default" :href="scope.row.storageDetail" :underline="false" target="_blank" style="padding-right:12px;">
                <i class="iconfont">&#xe665;</i>
              </el-link>
            </el-tooltip>
            <el-tooltip v-has="'res_mmc_media_resource_edit'" class="item" effect="dark" content="编辑" placement="top">
              <el-button class="reset-icon" @click="$router.push({ path: `/mmc/storeage/${scope.row.id}` })" type="text" >
                <i class="iconfont">&#xe71c;</i>
              </el-button>
            </el-tooltip>
            <el-tooltip v-has="'res_mmc_media_resource_delete'" class="item" effect="dark" content="删除" placement="top">
